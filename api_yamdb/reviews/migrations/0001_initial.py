    ...
    operations = [
            ...
            fields=[
                ...
                ('role', models.CharField(
                    choices=[('admin', 'admin'), ('moderator', 'moderator'),
                             ('user', 'user')], default='user', max_length=80,
                    verbose_name='Роль')),
                ('confirmation_code',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True,
                                        serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text='Введите наименование',
                                          verbose_name='Наименование')),
                ('year', models.IntegerField(default=2022, validators=[
                    django.core.validators.MinValueValidator(0),
                    reviews.models.max_value_current_year],
                                             verbose_name='Год выхода')),
                ('rating', models.IntegerField(default=10, validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='сomments',
                                   to='reviews.Review', verbose_name='Обзор')),
            ],
            options={
